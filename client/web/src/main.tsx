import { ChatPreferencesService, createChatStore, createSessionStore, DeviceIdentityService, MessengerService, PlaintextMessageCodec, SyncManager } from '@secure-messenger/client-core'
...
import { browserChatPreferencesStore } from './shared/platform/storage.ts'
import { browserDurableInbox } from './shared/platform/durableInbox.ts'
import { WebClientProvider } from './shared/application/WebClientProvider.tsx'
import './app/styles.css'

const realtime = new WebSocketManager(apiClient)
const identities = new DeviceIdentityService(browserDurableInbox, browserIdGenerator, browserDeviceDescription)
