"""Add V1 users, devices, and authentication sessions.
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "protocol_version", sa.Integer(), server_default="0", nullable=False
        ),
        sa.Column("identity_public_key", sa.LargeBinary(), nullable=True),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
            server_default=sa.func.now(),
